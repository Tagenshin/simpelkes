                ...
                ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <?php } ?>
                      <a href="?hal=detail_resep_apoteker&kd_resep=<?= $hs['kd_resep']; ?>&nm_pasien=<?= $hs['nm_pasien']; ?>&tgl_resep=<?= $hs['tgl_resep']; ?>&nm_poli=<?= $hs['nm_poli']; ?>&kategori=<?= $hs['kategori']; ?>" class="btn btn-success btn-sm">Detail Resep</a>
