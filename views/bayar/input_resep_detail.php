...
if (isset($_POST['input'])) {
    ...
    $query = mysqli_query($conn, "INSERT INTO tb_resep_detail VALUES('', '$kd_resep','$kd_obat','$jlh','$ket_detail')");
...
$data = mysqli_query($conn, "SELECT * FROM tb_pasien,tb_daftar,tb_periksa,tb_resep WHERE tb_pasien.nik=tb_daftar.nik && tb_periksa.kd_periksa=tb_resep.kd_periksa && tb_resep.kd_resep='$kd_resep'");
