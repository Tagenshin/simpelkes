...
if (isset($_POST['edit'])) {
    ...
    $data = mysqli_query($conn, "UPDATE tb_pegawai SET nip='$nip',nik='$nik',nm_pegawai='$nm_pegawai',jk='$jk',agama='$agama',alamat='$alamat' WHERE nip='$nip'");
    if ($data) {
        echo "
        ...
        echo "
          <script language=javascript>
            ...
            document.location.href='?hal=edit_pegawai'; 
          </script>";
    }
}
?>
...
include '../koneksi.php';
$nip = $_GET['nip'];
$data = mysqli_query($conn, "SELECT * FROM tb_pegawai WHERE nip='$nip'");
                    ...
                    <form action="" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input name="nip" type="text" id="nip" required="required" class="form-control" readonly value="<?= $hs['nip']; ?>">
                            </div>
                        </div>
                        <div class="item form-group">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input name="nm_pegawai" type="text" id="nm_pegawai" required="required" class="form-control" value="<?= $hs['nm_pegawai']; ?>">
                            </div>
                        </div>
                        <div class="item form-group">
